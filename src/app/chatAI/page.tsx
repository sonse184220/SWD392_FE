  ...
  return (
    <div className="container max-w-none flex h-full w-full flex-col items-center gap-8 bg-default-background pt-16 pr-8 pl-8">
      ...
      <div className="flex w-full max-w-[768px] grow shrink-0 basis-0 flex-col items-start relative">
        <div className="flex w-full grow shrink-0 basis-0 flex-col items-start gap-6 pb-6 overflow-auto">
        ...
        <div className="flex w-full max-w-[768px] flex-col items-start gap-10 bg-default-background">
          <input
            type="file"
            ref={fileInputRef}
            className="hidden"
          ...
          />
          <div className="flex w-full flex-col items-start gap-3 pb-6">
